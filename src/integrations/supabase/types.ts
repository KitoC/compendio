  ...
  public: {
    Tables: {
      ...
      data_navigation_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "data_navigation_items_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      data_views: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_data_navigation_item_id"
            columns: ["data_navigation_item_id"]
            isOneToOne: false
            referencedRelation: "data_navigation_items"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      quote_line_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_quote_item_id"
          ...
          {
            foreignKeyName: "quote_line_items_quote_item_id_fkey"
            columns: ["quote_item_id"]
            isOneToOne: false
            referencedRelation: "quote_items"
            referencedColumns: ["id"]
      ...
      quotes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "quotes_staff_member_id_fkey"
