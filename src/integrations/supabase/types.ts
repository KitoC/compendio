  ...
  public: {
    Tables: {
      ...
      data_table_record_labels: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_data_table_record_labels_tenant";
            columns: ["tenant_id"];
            isOneToOne: false;
            referencedRelation: "tenants";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "fk_data_table_record_labels_data_table_id";
          ...
          {
            foreignKeyName: "fk_data_table_record_labels_external_table_id";
            columns: ["external_table_id"];
            isOneToOne: false;
            referencedRelation: "data_tables";
            referencedColumns: ["id"];
          }
