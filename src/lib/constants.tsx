...
export const ROUTES = {
  ...
  CONVERSATION: "/:tenantId/app/conversation",
  CONVERSATIONS_DETAIL: "/:tenantId/app/conversations/:id",
  CUSTOM_TABLE_DATA: "/:tenantId/app/ct/:id",
  CONVERSATION_ASSISTANT: "/:tenantId/app/conversations/general-assistant",
