...
export const useCustomTableDataService = () => {
  ...
  return {
    ...
    async getTableData(
      ...
      try {
        ...
        const response = await fetch(
          `${functionsUrl}/custom-table-data/get?${queryParams.toString()}`,
          {
            method: "GET",
            headers: {
    ...
    async getRecordById(id: string): Promise<unknown> {
      try {
        const session = await supabase.auth.getSession();
        const token = session.data.session?.access_token;
        ...
        const functionsUrl = getSupabaseFunctionsUrl();
        const response = await fetch(
          `${functionsUrl}/custom-table-data/getById?id=${id}`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
    ...
    async createRecord(
      ...
      try {
        ...
        const functionsUrl = getSupabaseFunctionsUrl();
        const response = await fetch(
          `${functionsUrl}/custom-table-data/create`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
    ...
    async updateRecord(
      ...
      try {
        ...
        const response = await fetch(
          `${functionsUrl}/custom-table-data/update`,
          {
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
    ...
    async deleteRecord(id: string): Promise<boolean> {
      try {
        ...
        const functionsUrl = getSupabaseFunctionsUrl();
        const response = await fetch(
          `${functionsUrl}/custom-table-data/delete?id=${id}`,
          {
            method: "DELETE",
            headers: {
              "Content-Type": "application/json",
