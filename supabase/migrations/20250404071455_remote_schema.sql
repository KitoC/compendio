...
CREATE OR REPLACE FUNCTION "public"."can_access_tenant_data"("target_tenant_id" "uuid", "allowed_roles" "public"."user_role_type"[]) RETURNS boolean
    ...
    AS $$
  select
    auth.tenant_id()::uuid = target_tenant_id and
    exists (
      select 1
    ...
    IF NOT v_table_exists THEN
        ...
        EXECUTE format(
            'CREATE POLICY tenant_isolation_policy ON public.ct_%I
             FOR ALL
             USING (tenant_id = auth.tenant_id()::uuid)',
            NEW.name
        );
...
begin
  ...
  if with_tenant_check then
    base_clause := '((auth.tenant_id())::uuid = tenant_id)';
  else
...
CREATE OR REPLACE FUNCTION "public"."has_row_permission"("perms" "jsonb", "action" "text") RETURNS boolean
    LANGUAGE "sql" STABLE
    AS $$
  select exists (
  ...
  or exists (
    ...
    where has_role(auth.uid(), auth.tenant_id()::uuid, value::user_role_type)
  )
$$;


ALTER FUNCTION "public"."has_row_permission"("perms" "jsonb", "action" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."has_row_permission"("target_tenant_id" "uuid", "perms" "jsonb", "action" "text") RETURNS boolean
  ...
  AND auth.tenant_id()::uuid = target_tenant_id
$$;
...
CREATE POLICY "Admins and super-admins can delete agent_functions" ON "public"."agent_functions" FOR DELETE USING (((("auth"."tenant_id"())::"uuid" = "tenant_id") AND ("public"."has_role"("auth"."uid"(), "tenant_id", 'admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'super-admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'tenant-owner'::"public"."user_role_type"))));



CREATE POLICY "Admins and super-admins can insert agent_functions" ON "public"."agent_functions" FOR INSERT WITH CHECK (((("auth"."tenant_id"())::"uuid" = "tenant_id") AND ("public"."has_role"("auth"."uid"(), "tenant_id", 'admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'super-admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'tenant-owner'::"public"."user_role_type"))));



CREATE POLICY "Admins and super-admins can update agent_functions" ON "public"."agent_functions" FOR UPDATE USING (((("auth"."tenant_id"())::"uuid" = "tenant_id") AND ("public"."has_role"("auth"."uid"(), "tenant_id", 'admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'super-admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'tenant-owner'::"public"."user_role_type"))));



CREATE POLICY "Admins and super-admins can view agent_functions" ON "public"."agent_functions" FOR SELECT USING (((("auth"."tenant_id"())::"uuid" = "tenant_id") AND ("public"."has_role"("auth"."uid"(), "tenant_id", 'admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'super-admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'tenant-owner'::"public"."user_role_type"))));
...
CREATE POLICY "Allow insert for valid tenant owners" ON "public"."webhook_events" FOR INSERT WITH CHECK ((("auth"."uid"() IS NOT NULL) AND ("public"."has_role"("auth"."uid"(), "tenant_id", 'tenant-owner'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'super-admin'::"public"."user_role_type"))));



CREATE POLICY "Allow select for valid tenant owners" ON "public"."webhook_events" FOR SELECT USING ((("auth"."uid"() IS NOT NULL) AND ("public"."has_role"("auth"."uid"(), "tenant_id", 'tenant-owner'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'super-admin'::"public"."user_role_type"))));



CREATE POLICY "Allow super-admins only" ON "public"."encryption_keys" USING ("public"."has_role"("auth"."uid"(), NULL::"uuid", 'super-admin'::"public"."user_role_type"));
...
CREATE POLICY "Only tenanted user can CRUD" ON "public"."ai_agent_workflows" USING ((("auth"."tenant_id"())::"uuid" = "tenant_id")) WITH CHECK ((("auth"."tenant_id"())::"uuid" = "tenant_id"));



CREATE POLICY "Only tenanted user can CRUD" ON "public"."ai_agents" USING (("public"."is_tenant_user"("tenant_id") OR "public"."is_tenant_owner"("tenant_id") OR "public"."is_system_admin"())) WITH CHECK (("public"."is_tenant_user"("tenant_id") OR "public"."is_tenant_owner"("tenant_id") OR "public"."is_system_admin"()));



CREATE POLICY "Only tenanted user can CRUD" ON "public"."ai_functions" USING (("public"."is_tenant_user"("tenant_id") OR "public"."is_tenant_owner"("tenant_id") OR "public"."is_system_admin"())) WITH CHECK (("public"."is_tenant_user"("tenant_id") OR "public"."is_tenant_owner"("tenant_id") OR "public"."is_system_admin"()));



CREATE POLICY "Only tenanted user can CRUD" ON "public"."configs" USING ((("auth"."tenant_id"())::"uuid" = "tenant_id")) WITH CHECK ((("auth"."tenant_id"())::"uuid" = "tenant_id"));



CREATE POLICY "Only tenanted user can CRUD" ON "public"."connected_services" USING (((("auth"."tenant_id"())::"uuid" = "tenant_id") OR "public"."is_system_admin"())) WITH CHECK (((("auth"."tenant_id"())::"uuid" = "tenant_id") OR "public"."is_system_admin"()));
...
CREATE POLICY "Only tenanted user can CRUD" ON "public"."conversations" USING (((( SELECT "auth"."tenant_id"() AS "tenant_id"))::"uuid" = "tenant_id")) WITH CHECK (((( SELECT "auth"."tenant_id"() AS "tenant_id"))::"uuid" = "tenant_id"));



CREATE POLICY "Only tenanted user can CRUD" ON "public"."credentials" USING ((("auth"."tenant_id"())::"uuid" = "tenant_id")) WITH CHECK ((("auth"."tenant_id"())::"uuid" = "tenant_id"));



CREATE POLICY "Only tenanted user can CRUD" ON "public"."custom_migrations" USING ((("auth"."tenant_id"())::"uuid" = "tenant_id")) WITH CHECK ((("auth"."tenant_id"())::"uuid" = "tenant_id"));



CREATE POLICY "Only tenanted user can CRUD" ON "public"."custom_roles" USING ((("auth"."tenant_id"())::"uuid" = "tenant_id")) WITH CHECK ((("auth"."tenant_id"())::"uuid" = "tenant_id"));



CREATE POLICY "Only tenanted user can CRUD" ON "public"."custom_table_data" USING ((("auth"."tenant_id"())::"uuid" = "tenant_id")) WITH CHECK ((("auth"."tenant_id"())::"uuid" = "tenant_id"));



CREATE POLICY "Only tenanted user can CRUD" ON "public"."custom_table_definitions" USING ((("auth"."tenant_id"())::"uuid" = "tenant_id")) WITH CHECK ((("auth"."tenant_id"())::"uuid" = "tenant_id"));



CREATE POLICY "Only tenanted user can CRUD" ON "public"."custom_table_fields" USING ((("auth"."tenant_id"())::"uuid" = "tenant_id")) WITH CHECK ((("auth"."tenant_id"())::"uuid" = "tenant_id"));



CREATE POLICY "Only tenanted user can CRUD" ON "public"."custom_table_relationships" USING ((("auth"."tenant_id"())::"uuid" = "tenant_id")) WITH CHECK ((("auth"."tenant_id"())::"uuid" = "tenant_id"));
...
CREATE POLICY "Only tenanted user can CRUD" ON "public"."tenant_domains" USING ((("auth"."tenant_id"())::"uuid" = "tenant_id")) WITH CHECK ((("auth"."tenant_id"())::"uuid" = "tenant_id"));



CREATE POLICY "Only tenanted user can CRUD" ON "public"."webhook_events" USING ((("auth"."tenant_id"())::"uuid" = "tenant_id")) WITH CHECK ((("auth"."tenant_id"())::"uuid" = "tenant_id"));



CREATE POLICY "Only tenanted user can CRUD" ON "public"."workflow_instances" USING ((("auth"."tenant_id"())::"uuid" = "tenant_id")) WITH CHECK ((("auth"."tenant_id"())::"uuid" = "tenant_id"));



CREATE POLICY "Only tenanted user can CRUD" ON "public"."workflow_responses" USING ((("auth"."tenant_id"())::"uuid" = "tenant_id")) WITH CHECK ((("auth"."tenant_id"())::"uuid" = "tenant_id"));



CREATE POLICY "Only tenanted user can CRUD" ON "public"."workflow_steps" USING ((("auth"."tenant_id"())::"uuid" = "tenant_id")) WITH CHECK ((("auth"."tenant_id"())::"uuid" = "tenant_id"));



CREATE POLICY "Only tenanted user can CRUD" ON "public"."workflows" USING ((("auth"."tenant_id"())::"uuid" = "tenant_id")) WITH CHECK ((("auth"."tenant_id"())::"uuid" = "tenant_id"));
...
CREATE POLICY "Super-admins and tenant-owners can manage custom roles" ON "public"."custom_roles" USING (((("auth"."tenant_id"())::"uuid" = "tenant_id") AND ("public"."has_role"("auth"."uid"(), "tenant_id", 'super-admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'tenant-owner'::"public"."user_role_type"))));



CREATE POLICY "Super-admins and tenant-owners can manage user custom roles" ON "public"."user_custom_roles" USING (((("auth"."tenant_id"())::"uuid" = "tenant_id") AND ("public"."has_role"("auth"."uid"(), "tenant_id", 'super-admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'tenant-owner'::"public"."user_role_type"))));



CREATE POLICY "System Admin can do all" ON "public"."conversations" USING ("public"."is_system_admin"()) WITH CHECK ("public"."is_system_admin"());
...
CREATE POLICY "Users can insert own conversations" ON "public"."conversations" FOR INSERT WITH CHECK ((("auth"."uid"())::"text" = "user_id"));
...
CREATE POLICY "Users can update own conversations" ON "public"."conversations" FOR UPDATE USING ((("auth"."uid"())::"text" = "user_id"));
...
CREATE POLICY "Users can view own conversations" ON "public"."conversations" FOR SELECT USING (((("auth"."uid"())::"text" = "user_id") OR ("tenant_id" = ("auth"."tenant_id"())::"uuid")));
...
CREATE POLICY "tenant_admin_access_ai_agent_workflows" ON "public"."ai_agent_workflows" USING (((("auth"."tenant_id"())::"uuid" = "tenant_id") AND ("public"."has_role"("auth"."uid"(), "tenant_id", 'super-admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'tenant-owner'::"public"."user_role_type"))));



CREATE POLICY "tenant_admin_access_webhook_events" ON "public"."webhook_events" USING (((("auth"."tenant_id"())::"uuid" = "tenant_id") AND ("public"."has_role"("auth"."uid"(), "tenant_id", 'admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'super-admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'tenant-owner'::"public"."user_role_type"))));



CREATE POLICY "tenant_admin_access_workflow_instances" ON "public"."workflow_instances" USING (((("auth"."tenant_id"())::"uuid" = "tenant_id") AND ("public"."has_role"("auth"."uid"(), "tenant_id", 'admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'super-admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'tenant-owner'::"public"."user_role_type"))));



CREATE POLICY "tenant_admin_access_workflow_responses" ON "public"."workflow_responses" USING (((("auth"."tenant_id"())::"uuid" = "tenant_id") AND ("public"."has_role"("auth"."uid"(), "tenant_id", 'admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'super-admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'tenant-owner'::"public"."user_role_type"))));



CREATE POLICY "tenant_admin_access_workflow_steps" ON "public"."workflow_steps" USING (((("auth"."tenant_id"())::"uuid" = "tenant_id") AND ("public"."has_role"("auth"."uid"(), "tenant_id", 'admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'super-admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'tenant-owner'::"public"."user_role_type"))));



CREATE POLICY "tenant_admin_access_workflows" ON "public"."workflows" USING (((("auth"."tenant_id"())::"uuid" = "tenant_id") AND ("public"."has_role"("auth"."uid"(), "tenant_id", 'super-admin'::"public"."user_role_type") OR "public"."has_role"("auth"."uid"(), "tenant_id", 'tenant-owner'::"public"."user_role_type"))));
...
GRANT ALL ON FUNCTION "public"."has_row_permission"("perms" "jsonb", "action" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."has_row_permission"("perms" "jsonb", "action" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."has_row_permission"("perms" "jsonb", "action" "text") TO "service_role";
